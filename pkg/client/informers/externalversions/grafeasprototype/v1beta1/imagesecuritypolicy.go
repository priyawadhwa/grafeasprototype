	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.GrafeasprototypeV1beta1().ImageSecurityPolicies(namespace).List(options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.GrafeasprototypeV1beta1().ImageSecurityPolicies(namespace).Watch(options)
			},
		},
		&grafeasprototype_v1beta1.ImageSecurityPolicy{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *imageSecurityPolicyInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&grafeasprototype_v1beta1.ImageSecurityPolicy{}, f.defaultInformer)
}

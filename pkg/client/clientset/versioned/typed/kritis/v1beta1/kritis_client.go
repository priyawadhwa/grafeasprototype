...
import (
	...
	"github.com/priyawadhwa/kritis/pkg/client/clientset/versioned/scheme"
...
func (c *KritisV1beta1Client) ImagePolicyRequirements(namespace string) ImagePolicyRequirementInterface {
...
func NewForConfig(c *rest.Config) (*KritisV1beta1Client, error) {
	...
	return &KritisV1beta1Client{client}, nil
}

// NewForConfigOrDie creates a new KritisV1beta1Client for the given config and
...
func New(c rest.Interface) *KritisV1beta1Client {
	return &KritisV1beta1Client{c}
}
